...
//配置域名,域名只修改此处。
//如果wordpress没有安装在网站根目录请加上目录路径,例如："www.alongparty.cn/blog"
var DOMAIN = "www.alongparty.cn";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="蜷缩的蜗牛"; //网站名称
...
var ZANIMAGEURL = 'https://www.alongparty.cn/images/2017/07/zsm400.jpg';//微信赞赏的图片链接，用于个人小程序的赞赏
...
var DOWNLOADFILEDOMAIN = [
  { id: 1, domain: 'www.alongparty.cn' },
  { id: 2, domain: 'music.alongparty.cn' },
  { id: 3, domain: 'music.163.com' }
]
 //首页图标导航
